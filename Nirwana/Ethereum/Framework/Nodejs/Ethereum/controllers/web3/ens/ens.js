...
exports.resolver = function (req, res) {
    ...
    if (req.app.locals.web3) {
        ...
        connectionObject.eth.ens.resolver('ethereum.eth').then((contract) => {
...
exports.getAddress = function (req, res) {
    ...
    if (req.app.locals.web3) {
        let connectionObject = req.app.locals.web3
        connectionObject.eth.ens.getAddress(req.ensName).then((address) => {
            console.log(address);
            res.json({
                address: address,
                sucess: true
...
exports.setAddress = function (req, res) {
    ...
    if (req.app.locals.web3) {
        ...
        connectionObject.eth.ens.setAddress(
            req.ensName,
            req.addressToSet,
            option
        )
            ...
            .on('confirmation', (confirmationNumber, receipt) => {
                EventManager.emitEvent("ENS:setAddress:confirmation", confirmationNumber)
            })
            .on('receipt', (receipt) => {
...
exports.getPubkey = function (req, res) {
    ...
    if (req.app.locals.web3) {
        let connectionObject = req.app.locals.web3
        connectionObject.eth.ens.getPubkey(req.ensName).then((address) => {
            console.log(address);
            res.json({
                address: address,
                sucess: true
...
exports.setPubkey = function (req, res) {
    ...
    if (req.app.locals.web3) {
        ...
        // Or using the event emitter
        connectionObject.eth.ens.setPubkey(
            req.ensName,
            ...
            .on('confirmation', (confirmationNumber) => {
                EventManager.emitEvent("ENS:setPubkey:confirmation", confirmationNumber)
            })
            .on('receipt', (receipt) => {
...
exports.getText = function (req, res) {
    ...
    if (req.app.locals.web3) {
        let connectionObject = req.app.locals.web3
        connectionObject.eth.ens.getText(req.ensName, req.key).then((address) => {
            console.log(address);
            res.json({
                address: address,
                sucess: true
...
exports.setText = function (req, res) {
    ...
    if (req.app.locals.web3) {
        ...
        // Or using the event emitter
        connectionObject.eth.ens.setText(
            req.ensName,
            req.key,
            req.value,
            option
...
exports.getContent = function (req, res) {
    ...
    if (req.app.locals.web3) {
        let connectionObject = req.app.locals.web3
        connectionObject.eth.ens.getContent(req.ensName).then((result) => {
            console.log(result);
            res.json({
                result: result,
                sucess: true
...
exports.setContent = function (req, res) {
    ...
    if (req.app.locals.web3) {
        ...
        // Or using the event emitter
        connectionObject.eth.ens.setContent(
            req.ensName,
            req.hash,
            option
        )
            ...
            .on('confirmation', (confirmationNumber) => {
                EventManager.emitEvent("ENS:setContent:confirmation", confirmationNumber)
            })
            .on('receipt', (receipt) => {
...
exports.getMultihash = function (req, res) {
    ...
    if (req.app.locals.web3) {
        let connectionObject = req.app.locals.web3
        connectionObject.eth.ens.getMultihash(req.ensName).then((result) => {
            console.log(result);
            res.json({
                result: result,
                sucess: true
...
exports.setMultihash = function (req, res) {
    ...
    if (req.app.locals.web3) {
        ...
        // Or using the event emitter
        connectionObject.eth.ens.setMultihash(
            req.ensName,
            req.hash,
            option
        )
            ...
            .on('confirmation', (confirmationNumber) => {
                EventManager.emitEvent("ENS:setMultihash:confirmation", confirmationNumber)
            })
            .on('receipt', (receipt) => {
...
exports.getContenthash = function (req, res) {
    ...
    if (req.app.locals.web3) {
        let connectionObject = req.app.locals.web3
        connectionObject.eth.ens.getContenthash(req.ensName).then((result) => {
            console.log(result);
            res.json({
                result: result,
                sucess: true
...
exports.setContenthash = function (req, res) {
    ...
    if (req.app.locals.web3) {
        ...
        // Or using the event emitter
        connectionObject.eth.ens.setContenthash(
            req.ensName,
            req.hash,
            option
        )
            ...
            .on('confirmation', (confirmationNumber) => {
                EventManager.emitEvent("ENS:setContenthash:confirmation", confirmationNumber)
            })
            .on('receipt', (receipt) => {

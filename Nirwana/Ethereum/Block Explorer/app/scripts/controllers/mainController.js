    ...
    .controller('mainCtrl', function ($rootScope, $scope, $location) {
        ...
        function updateTXList() {
            ...
            for (var i=0; i < 10 && currentTXnumber - i>= 0; i++) {
              var recentTXn = web3.eth.getTransactionFromBlock(121440);
              
              console.log(recentTXn);
              $scope.recenttransactions.push(recentTXn);
            }
        }
        ...
        function getTransactionPerSec(){
          var gasPrice = 21000;
          var gasLimit = parseFloat(($scope.gasLimit).replace(/,/g, ""))  ;

          $scope.transactionPerSecond = parseInt((gasLimit/gasPrice)/$scope.blocktime);
        }
